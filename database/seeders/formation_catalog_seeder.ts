    ...
    const catalogs = [
      {
        ...
        description:
          "Catalogue complet des formations techniques Rexel pour l'année 2024. Découvrez nos formations en électricité, automatisme, énergies renouvelables et domotique.",
      ...
      },
      {
        ...
        description:
          'Guide pratique des habilitations électriques selon la norme NF C 18-510. Formations obligatoires pour travailler en sécurité sur les installations électriques.',
      ...
      },
      {
        ...
        description:
          "Catalogue spécialisé dans les formations énergies renouvelables: solaire photovoltaïque, éolien, systèmes hybrides et stockage d'énergie.",
